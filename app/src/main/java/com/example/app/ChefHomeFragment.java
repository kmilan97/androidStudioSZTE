        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot snapshot1:snapshot.getChildren()){
                    UpdateExtensionsModel updateExtensionsModel = snapshot1.getValue(UpdateExtensionsModel.class);
                    updateExtensionsModelList.add(updateExtensionsModel);
                }
                adapter = new ChefHomeAdapter(getContext(), updateExtensionsModelList);
