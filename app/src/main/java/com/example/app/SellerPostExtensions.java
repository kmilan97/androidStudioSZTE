...
public class SellerPostExtensions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_post_extensions);
    ...
    private void uploadImage() {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(SellerPostExtensions.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ExtensionsDetails info = new ExtensionsDetails(dishes,quantity,price,descrption,String.valueOf(uri),RandomUID,ChefId);
                            firebaseDatabase.getInstance().getReference("FoodDetails").child(State).child(City).child(Area).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(SellerPostExtensions.this,"Dish Posted Successfully!",Toast.LENGTH_SHORT).show();
                                }
                            });
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(SellerPostExtensions.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                }
