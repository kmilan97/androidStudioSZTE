        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(statee.equals("Maharashtra")){
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(SellerRegistration.this,android.R.layout.simple_spinner_item,list);
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if(task.isSuccessful()){
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(SellerRegistration.this,"Error",task.getException().getMessage());
                                                        }
                                                    }
                                                });
