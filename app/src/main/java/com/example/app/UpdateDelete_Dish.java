...
public class UpdateDelete_Dish extends AppCompatActivity {
        ...
        dataa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                food.setMessage("Your Extension Has Been Deleted!");
                                food.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        startActivity(new Intent(UpdateDelete_Dish.this, SellerExtensionsPanel_BottomNavigation.class));
                                    }
                                });
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        UpdateExtensionsModel updateExtensionsModel = snapshot.getValue(UpdateExtensionsModel.class);
                        desc.getEditText().setText(updateExtensionsModel.getDescription());
                        qty.getEditText().setText(updateExtensionsModel.getQuantity());
                        Dishname.setText("Dish name:"+ updateExtensionsModel.getDishes());
                        dishes= updateExtensionsModel.getDishes();
                        pri.getEditText().setText(updateExtensionsModel.getPrice());
                        Glide.with(UpdateDelete_Dish.this).load(updateExtensionsModel.getImageURL()).into(imageButton);
                        dburi = updateExtensionsModel.getImageURL();
                    }
    ...
    private void updatedesc(String buri) {
        ...
        ExtensionsDetails info = new ExtensionsDetails(dishes,quantity,price,description,buri,ID,ChefId);
        firebaseDatabase.getInstance().getReference("FoodDetails").child(State).child(City).child(Area)
