package com.example.app.SellerExtensionsPanel;
...
import com.example.app.SellerPostExtensions;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        postDish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getContext(), SellerPostExtensions.class));
            }
        });
